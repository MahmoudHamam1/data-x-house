...
dag = DAG(
    'build_datamart_delivery',
    default_args=default_args,
    description='Build the datamart in the delivery layer',
    schedule=None,  # Manual trigger only
    catchup=False,
    tags=['datamart','delivery','iceberg'],
)


create_datamarts = SparkSubmitOperator(
    task_id='create_datamarts',
    application='/opt/airflow/scripts/delivery/create_datamarts.py',
    conn_id='spark',
    conf={

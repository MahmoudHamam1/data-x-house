...
dag = DAG(
    'test_connections_with_spark_hive',
    default_args=default_args,
    description='Test all connections including comprehensive Spark-Hive integration',
    schedule=None,  # Manual trigger only
    catchup=False,
    tags=['test', 'connections', 'spark-hive', 'comprehensive'],
)
...
def create_spark_hive_test_script():
    ...
    print("Created Spark-Hive integration test script")
...
# Test Spark basic functionality
...
# Test comprehensive Spark-Hive integration
test_spark_hive_integration = SparkSubmitOperator(
    ...
    conf={
        'spark.pyspark.python': 'python3.11',
        'spark.driver.port': '7003',  # Different port to avoid conflicts
        'spark.blockManager.port': '7004',
...
test_network_task >> [test_hdfs_task, create_spark_hive_script_task]
create_spark_hive_script_task >> test_spark_basic
test_spark_basic >> test_spark_hive_integration
[test_hdfs_task, test_spark_hive_integration] >> test_hive_task
...
init_db_create_star_schema = SparkSubmitOperator(
    task_id='init_db_create_star_schema',
    ...
    name='init_db_create_star_schema',
    # verbose=True,
    dag=dag,
)
...
init_db_create_star_schema >> populate_star_schema
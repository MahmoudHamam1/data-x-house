...
refresh_star_schema = SparkSubmitOperator(
    task_id='refresh_star_schema',
    application='/opt/airflow/scripts/transform/datawarehouse/refresh_star_schema.py',
    conn_id='spark',
    conf={
        ...
        'hadoop.security.key.provider.path': 'kms://http@dx-master:9600/kms',
        'spark.hadoop.hadoop.security.key.provider.path':    'kms://http@dx-master:9600/kms',
        'spark.hadoop.dfs.encryption.key.provider.uri':      'kms://http@dx-master:9600/kms',
